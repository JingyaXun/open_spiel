...
from open_spiel.python.egt import dynamics_beta
...
def _build_dynamics2x2():
  ...
  return dynamics.MultiPopulationDynamics(payoff_tensor, dynamics_beta.replicator)
...
def _build_dynamics3x3():
  ...
  payoff_tensor = utils.game_payoffs_array(game)
  return dynamics.SinglePopulationDynamics(payoff_tensor, dynamics_beta.replicator)

def _build_dynamics2x2_beta():
  """Build multi-population dynamics."""
  game = pyspiel.load_game("matrix_pd")
  payoff_tensor = utils.game_payoffs_array(game)
  return dynamics.MultiPopulationDynamics(payoff_tensor, dynamics_beta.replicator_beta)
...
def _build_dynamics3x3_beta():
  ...
  game = pyspiel.load_game("matrix_rps")
  payoff_tensor = utils.game_payoffs_array(game)
  return dynamics.SinglePopulationDynamics(payoff_tensor, dynamics_beta.replicator_beta)
...
#     res = ax.quiver(dyn)
#     plt.savefig("test_quiver2x2.png")
...
#     plt.savefig("test_streamplot2x2.png")
...
#     res = ax.quiver(dyn)
#     plt.savefig("test_quiver3x3.png")
#     self.assertIsInstance(res, Quiver)
  ...
  def test_streamplot3x3(self):
    ...
    ax = fig.add_subplot(111, projection="3x3")
    res = ax.streamplot(dyn)
    plt.savefig("test_streamplot3x3_03.png")
    self.assertIsInstance(res, visualization.SimplexStreamMask)

#####################

#   def test_quiver2x2_beta(self):
#     """Test 2x2 quiver plot."""
#     dyn = _build_dynamics2x2_beta()
#     fig = plt.figure(figsize=(4, 4))
#     ax = fig.add_subplot(111, projection="2x2")
#     res = ax.quiver(dyn)
#     plt.savefig("test_quiver2x2_beta.png")
#     self.assertIsInstance(res, Quiver)

#   def test_streamplot2x2_beta(self):
#     """Test 2x2 quiver plot."""
#     dyn = _build_dynamics2x2_beta()
#     fig = plt.figure(figsize=(4, 4))
#     ax = fig.add_subplot(111, projection="2x2")
#     res = ax.streamplot(dyn)
#     plt.savefig("test_streamplot2x2_beta.png")
#     self.assertIsInstance(res, StreamplotSet)

#   def test_quiver3x3_beta(self):
#     """Test 3x3 quiver plot."""
#     dyn = _build_dynamics3x3_beta()
#     fig = plt.figure(figsize=(4, 4))
#     ax = fig.add_subplot(111, projection="3x3")
#     res = ax.quiver(dyn)
#     plt.savefig("test_quiver3x3_beta.png")
#     self.assertIsInstance(res, Quiver)

  def test_streamplot3x3_beta(self):
    """Test 3x3 quiver plot."""
    dyn = _build_dynamics3x3_beta()
    fig = plt.figure(figsize=(4, 4))
    ax = fig.add_subplot(111, projection="3x3")
    res = ax.streamplot(dyn)
    plt.savefig("test_streamplot3x3_beta5.png")
    self.assertIsInstance(res, visualization.SimplexStreamMask)
