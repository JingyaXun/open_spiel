...
mkdir -p /root/Documents/ICML2020/open_spiel/open_spiel/python/examples/ICML_Experiments_Dynamics_2players/kuhn_poker_experiments
...
run_experiment() {
    ...
    NUM_EXPERIMENTS=10
    ITERATIONS=8000
    OUT_DIR=ICML_Experiments_Dynamics_2players
    POLICY=lin
    ...
    --out=$OUT_DIR/${GAME}_experiments/${GAME}_${ADAPTIVE_ALPHA}_${INCREASE}_${POLICY}_${ALPHA}_${ITERATIONS}_${SEMI_PERCENT}_${EXPLOIT_RATE}_${EXP_EXPLOIT_RATE}.txt \
...
then
    ...
    do
        run_experiment kuhn_poker 0 1 1 $alpha 0.5 100 1
    done

    # linear increase
    for alpha in 1.1 1.2 1.3 1.4
    do
        run_experiment kuhn_poker 1 1 1 $alpha 0.5 100 1
    done
...
then
    # linear increase
    for alpha in 1.05 1.1 1.15 1.2 1.25 1.3 1.35 1.4
    do
        run_experiment kuhn_poker 1 1 1 $alpha 0.5 100 1
    done
...
#588
    ...
    # experiments for fixed alpha
    for alpha in 1 1.05 1.1 1.15 1.2 1.25 1.3 1.35 1.4
    do
        run_experiment kuhn_poker 0 1 1 $alpha 0.5 100 1
    done
fi
